...
### 🚀 Features
  ...
  - [x] Storage is obtained through a lightweight database, for greater convenience in a demo application, such as [`SQLite3`](https://sqlite.org/) managed by the [`Ecto`](https://hexdocs.pm/ecto/getting-started.html) library.
